...
fireIncidents
using csv
options(path  "/mnt/davis/fire-incidents/fire-incidents-2016.csv",
inferSchema "True",
header "true")
...
fireincidents
where 
`Incident Date` = '2016-09-27' or `Incident Date` = '2016-04-04'
...
and
`Incident Date` IN( '2016-09-27' ,'2016-04-04')
...
-- TODO
select count(`Ignition Cause`), `Ignition Cause`
from fireincidents
...
using csv
options(path  "/mnt/davis/fire-calls/fire-calls-truncated-comma.csv",
inferSchema "True",
header "true")
